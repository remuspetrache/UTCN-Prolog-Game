...
puzzle_title("Restanțele din UTCN — serie nouă 1").
puzzle_difficulty(mediu).

% ---------------------------------------------------------------------------
% Characters: character(Cell, Name, Role, Group)
% ---------------------------------------------------------------------------
character(a1, 'Constantin', student, 311).
character(b1, 'Diana',      student, 311).
character(c1, 'Vlad',       student, 311).
character(d1, 'Iulia',      student, 311).

character(a2, 'Eduard',   student,  311).
character(b2, 'Camelia',  profesor, cadre).
character(c2, 'Natalia',  laborant, cadre).
character(d2, 'Ciprian',  profesor, cadre).

character(a3, 'Ilie',     student,  312).
character(b3, 'Maria',    student,  312).
character(c3, 'Raul',     student,  312).
character(d3, 'Radu',     student,  312).

character(a4, 'Joshua',   student,  312).
character(b4, 'Remus',    asistent, asistenti).
character(c4, 'Rafael',   student,  312).
character(d4, 'Tudor',    student,  312).

character(a5, 'Virag Raul',  student, 312).
character(b5, 'Tifrea Raul', student, 312).
character(c5, 'Trif Andrei', student, 312).
character(d5, 'Varga Andrei', student, 312).
