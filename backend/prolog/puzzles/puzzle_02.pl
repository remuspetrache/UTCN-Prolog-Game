...
puzzle_title("Restanțele din UTCN — serie nouă 2").
puzzle_difficulty(mediu).

% ---------------------------------------------------------------------------
% Characters
% ---------------------------------------------------------------------------
character(a1, 'Jawad',     student, 311).
character(b1, 'Apor',      student, 311).
character(c1, 'Ilie',      student, 311).
character(d1, 'Andrei',    student, 311).

character(a2, 'Bogdan',    student, 311).
character(b2, 'Camelia',   profesor, cadre).
character(c2, 'Natalia',   laborant, cadre).
character(d2, 'Ciprian',   profesor, cadre).

character(a3, 'Roxana',    student, 312).
character(b3, 'Cristina',  student, 312).
character(c3, 'Dennis',    student, 312).
character(d3, 'Catalin',   student, 312).

character(a4, 'Gaspar Robert',  student, 312).
character(b4, 'Remus',          asistent, asistenti).
character(c4, 'Gavrila Robert', student, 312).
character(d4, 'Patricia',       student, 312).

character(a5, 'Szabo',     student, 312).
character(b5, 'Sorana',    student, 312).
character(c5, 'Rafail',    student, 312).
character(d5, 'Maria',     student, 312).
